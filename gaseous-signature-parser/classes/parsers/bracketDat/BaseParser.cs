...
namespace gaseous_signature_parser.classes.bracketparsers
{
    public abstract class BaseParser : IParser
    {
        ...
        public abstract RomSignatureObject Parse(string datFile, Dictionary<string, object>? options = null);

        public abstract parser.SignatureParser GetDatType(string datFile);

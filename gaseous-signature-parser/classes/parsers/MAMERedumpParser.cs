...
{
    public class MAMERedumpParser : IParser
    {
        ...
        public RomSignatureObject Parse(string XMLFile, Dictionary<string, object>? options = null)
        {
            ...
            foreach (XmlNode xmlGame in xmlGames)
            {
                ...
                gameObject.System = MAMERedumpObject.Name;
                ...
                {
                    MAMERedumpObject.Games.Add(gameObject);
                }
            }
        ...
        public parser.SignatureParser GetXmlType(XmlDocument xml)
        {
            ...
            var nodeHomepage = xmlHeader.SelectSingleNode("author");

            if (nodeHomepage != null && nodeHomepage.InnerText.StartsWith("MAME Redump", StringComparison.OrdinalIgnoreCase))
            {
                return parser.SignatureParser.MAMERedump;
            }

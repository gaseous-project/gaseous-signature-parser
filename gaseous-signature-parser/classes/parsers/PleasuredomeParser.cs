...
{
    public class PleasuredomeParser : IParser
    {
        ...
        public RomSignatureObject Parse(string XMLFile, Dictionary<string, object>? options = null)
        {
            ...
            signatureObject.SourceType = "Pleasuredome";
                ...
                foreach (XmlNode childNode in xmlMachine.ChildNodes)
                {
                    switch (childNode.Name.ToLower())
                    {
                        ...
                        case "disk":
                            ...
                            rom.SignatureSource = RomSignatureObject.Game.Rom.SignatureSourceType.Pleasuredome;
